...
BEGIN
    -- Drop and recreate cleanly every time this procedure runs
    DROP TABLE IF EXISTS dataschool_project.main_waste_collection_23_25;

    CREATE TABLE dataschool_project.main_waste_collection_23_25 (
    ...
    INTO TABLE dataschool_project.main_waste_collection_23_25
    ...
    -- Import 2023-24
    LOAD DATA LOCAL INFILE 'C:/Users/aDesktop/Development/DataSchoolProject/PlasticRecyclingProject/Datasets/OriginalResources/Q100+Waste+Collection+data+England+2023-24.csv'
    INTO TABLE dataschool_project.main_waste_collection_23_25
    FIELDS TERMINATED BY ','
    ENCLOSED BY '"'
    LINES TERMINATED BY '\n'
